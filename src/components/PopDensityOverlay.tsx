...
export const PopDensityOverlay = () => {
    ...
    useEffect(() => {
        ...
        const domain = jenks(censustracts.features.map(d => d.properties.POPDENS20), 8)
        const colorScale = scaleThreshold(domain, ['#ffffff','#d6d6d6','#bdbdbd','#8f8f8f','#737373','#525252','#252525','#0a0a0a',"#000000"])
